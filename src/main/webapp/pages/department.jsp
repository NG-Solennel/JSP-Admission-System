      ...
      <div class="container">
        <div class="main-sub row align-items-center pt-2">
            ...
            <table id="mytable" class="table align-middle mb-0 bg-white">
             ...
             %>
                <tr>
                  ...
                  <td>
                    <p class="fw-bold fw-normal mb-1"><%=department.getName() %></p>
                  </td>
                </tr>
                <%}%>
              </tbody>
          ...
          <div class="form-container mt-5">
 			 <h2>Add Faculty</h2>
 			 <form method="POST" action="<%=request.getContextPath()%>/department">
			  <label for="faculty">Faculty</label>
			 <select name="faculty" class="form-select select" aria-label="Default select example">
				 <%
				 List<AcademicUnit> faculties = dao.getFaculties();
...
const form = document.querySelector("form")
	...
	form.addEventListener("submit",(e)=>{
		if(name.value === null || name.value === ""){
			e.preventDefault()
			alert("Please add in a name of the faculty")
		}
	})
</script>
  </body>
