...
<%@page import="net.sol.dao.ApplicantDao"%>
<%@page import="java.util.ArrayList"%>
<%@page import="net.sol.model.Applicant"%>
            ...
            <table id="mytable" class="table align-middle mb-0 bg-white">
              ...
              %>
                <tr>
                  ...
                  <td>
                    <span
                      ><a
                        ...
                        ><img
                          src="data:image/jpeg;base64,<%= Base64.getEncoder().encodeToString(applicant.getPhoto()) %>"
                  ...
                  <td>
                    <p class="fw-bold fw-normal mb-1"><%=applicant.getEmail()%></p>
                  </td>
                  
                  
                  <td><%=applicant.getFaculty()%></td>
                  <td><%=applicant.getDepartment() %></td>
                  
                  <td>
                    <span class="badge badge-success rounded-pill d-inline"
                      ><%=applicant.getProgram()%></span
                    >
                  </td>
