      ...
      <div class="container">
        <div class="main-sub row align-items-center pt-2">
            ...
            <table id="mytable" class="table align-middle mb-0 bg-white">
             ...
             %>
                <tr>
                  ...
                  <td>
                    <p class="fw-bold fw-normal mb-1"><%=faculty.getName() %></p>
                  </td>
                </tr>
                <%}%>
              </tbody>
          ...
          <div class="form-container mt-5">
			 ...
			 <select name="program" class="form-select select" aria-label="Default select example">
				 <%
				 List<AcademicUnit> programs = dao.getPrograms();
